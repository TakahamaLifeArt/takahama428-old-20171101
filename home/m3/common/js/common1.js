...
function slideCheck(){
	$('.slideBox').each(function(){
		var sb = $(this);
		sb.removeClass('bgW');
		sb.find('input:checkbox').each(function(){
			if($(this).is(':checked')){
				sb.addClass('bgW');
			}
		});
...
$(function(){
	var addBtn = $('#addBtn a'),
		addarea = $('#addarea'),
		addConts = $('.addConts' , addarea);

	addBtn.click(function(){
		var clone = addConts.clone();
		clone.appendTo($('#addarea'));
		clone.find('input[type="text"]').val('').addClass('off');
		return false;
	});

	var requiedText = $('.requiedText');
	requiedText.on('blur', function() {
		if ($(this).val() != '') {
...
// 追加 Item Accordion (Main)
$(function(){
	$("#itemsOpen").click(function(){
		$(this).next().slideToggle("fast");
		$(this).addClass("close");
		$('#itemsClose').removeClass("close");
	});
});
