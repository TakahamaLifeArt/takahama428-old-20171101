...
<div id="header">
	...
	?>
				...
				?>
					<div id="sns">
						...
						<div class="googleplus">
							<div class="g-plusone" data-href="http://www.takahama428.com" data-align="right"></div>
						</div>
						...
						<!-- facebook -->
						<div class="facebook">
							<div class="fb-like" data-href="https://www.facebook.com/takahamalifeart" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="inner">
				<div class="h_wrap hw_1">
					<a href="/" onclick="ga('send','event','logo','click','header');"><img src="/common/img/header/logo.png" alt="オリジナルTシャツ屋"></a>
				</div>
				...
				<div class="h_wrap hw_3">
					...
					<div class="h_mail">
						<a href="/contact/" onclick="ga('send','event','contact','click','header');">
							...
							<span></span>
							<p>お問い合わせ（相談）はこちら</p>
							<img src="/common/img/header/arrow_w.png" class="h_arrow">
						</a>
					</div>
				</div>
			...
			<div id="top_menu">
				<div class="inner">
					...
					<div class="login_btn">
						<a href="/user/history.php" id="mypage_btn"><img src="/common/img/header/login_btn.png">マイページ</a>
					</div>
					<?php
			...
			<div class="inner">
				<div class="how_to_mypage">
					<p>
						<a href="/user/about_tlamembers.php" onclick="ga('send','event’,’how_to_mypage','click’,’top’);"> <img src="/common/img/header/sankaku_bule.png">マイページとは </a>
					</p>
				</div>
				<?php
					if(!empty($_SESSION['me'])){
