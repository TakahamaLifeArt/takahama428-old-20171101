...
<html>
	...
	<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#  website: http://ogp.me/ns/website#">
		...
		<link rel="stylesheet" type="text/css" href="./css/order_responsive.css?v=<?php echo $_version;?>" media="screen" />
		...
		<script type="text/javascript" src="/common/js/tlalib.js?v=<?php echo $_version;?>"></script>
		<script type="text/javascript" src="./js/t_orderform.js?v=<?php echo $_version;?>"></script>
		...
		<!--m3 begin-->
		<script src="/m3/common/js/common1.js?v=<?php echo $_version;?>"></script>
		<!--m3 end-->
					...
					<div id="step3">
						...
						<div class="step_inner">
							...
							<div class="arrow_line">
								...
								<div class="step_next goto_cart" onclick="ga('send','event','step3','click','order',5300);">カートに入れる</div>
							</div>
						</div>
					</div>
...
<!--											<label><input type="radio" name="payment" value="4" <?php if($regist['options']['payment']==4) echo 'checked="checked"'; ?> />コンビニ決済（手数料800円）</label>-->
							...
							<div class="arrow_line">
								...
								<div class="step_next goto_user" onclick="ga('send','event','step4','click','order',5300);">次へ進む</div>
							</div>
						</div>
					</div>
					...
					<div id="step5">
						...
						<div class="step_inner">
								...
								<div id="user_wrap" class="clearfix inner">
										...
										<div class="ft">
											<ul>
												...
												<li id="login_email" class="login_nodisplay">
													<h2>メールアドレス:<span class="fontred">※</span></h2><input type="text" id="login_input_email" name="login_input_email" value="<?php echo $user['email']; ?>" /></li>
												<li class="login_nodisplay">
													<h2>パスワード　　:<span class="fontred">※</span></h2><input type="password" value="<?php echo $user['password']; ?>" id="login_input_pass" name="login_input_pass" /></li>
											</ul>
										</div>
										<div class="ft">
											<ul>
									...
									<div class="ft">
										<ul>
											...
											<li id="login_email">
												<h2>メールアドレス:<span class="fontred">※</span></h2><input type="text" id="email" name="email" value="<?php echo $user['email']; ?>" /></li>
											<li class="login_nodisplay">
												<h2>新規 パスワード:<span class="fontred">※</span></h2><input type="password" value="<?php echo $user['password']; ?>" id="pass" name="pass" /></li>
									...
									<div class="fl">
										<ul>
											...
											<li>
												<h2>お電話番号:<span class="fontred">※</span></h2><input type="text" id="tel" name="tel" class="forPhone" value="<?php echo $user['tel']; ?>" /></li>
										</ul>
									</div>
									<div class="fr">
										<ul>
											...
											<li>
												<h2>ご要望・ご質問など:</h2><textarea cols="30" rows="5" name="comment"><?php echo $user['comment']; ?></textarea></li>
										</ul>
									</div>
								</div>
							...
							<div class="arrow_line">
								...
								<div class="step_next goto_confirm" onclick="ga('send','event','step5','click','order',5300);">確認画面へ</div>
							</div>
						</div>
					</div>
			...
			<div id="floatingbox">
				<table>
					...
					<tbody>
						<tr>
							<th>商品枚数</th>
							<td><span><?php echo number_format($data['amount']); ?></span>枚</td>
						</tr>
						<tr class="total">
							<th>合計金額</th>
							<td><span><?php echo number_format($total); ?></span>円</td>
						</tr>
						<tr>
							<th>1枚あたり</th>
							<td><span><?php echo number_format($perone); ?></span>円</td>
						</tr>
					</tbody>
				</table>
