                                            ...
                                            <ul class="maker_'.$v['maker_id'].'">
                                                ...
                                                <li class="item_info_s">
                                                    ...
                                                    <p class="price_s" style="white-space: nowrap;">
                                                        ...
                                                        <span id="price_cost" style="white-space: nowrap;"><span>'.$v['minprice'].'</span>円xA啓/span>
                                                    </p>
...
地域によりご希望に添えない場合がございますので、予めご了承願います。</p>
						...
						<div class="arrow_line"><div class="arrow prev" data-back="0"><span>別の商品を見る</span></div><div class="step_next goto_user">次へ進む</div></div>
                    </div>
				</div>
